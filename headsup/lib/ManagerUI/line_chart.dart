...
class LineChartSample1 extends StatefulWidget {
  ...
  LineChartSample1({Key key, @required this.something}) : super(key: key);

  @override
  _LineChartSample1State createState() => _LineChartSample1State(something);
}

class _LineChartSample1State extends State<LineChartSample1> {
  String something;
  _LineChartSample1State(this.something);
